...
const { calculatePriceForBundlePercent, floor, getPriceEstimates } = require("./misc");
...
bundleScene.action("simulate_bundle", async (ctx) => {
  ...
  } = getPriceEstimates(ethToAddToLP, percentageTokenToAddToLp, numOfWallets, totalSupply)
